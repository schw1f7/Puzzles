...
public class FarmerProblem extends Problem {
    ...
    public FarmerProblem(){
        ...
        super.setMover(new com.example.mythm.puzzles2.domains.farmer.FarmerMover());
    ...
    private final String INTRO = 
                        "A farmer and his wolf, goat, and cabbage come to the " +
                        "edge of a river they wish to cross. There is a boat " +
                        "at the river's edge that only the farmer can row. The " +
                        "farmer can take at most one other object besides himself " +
